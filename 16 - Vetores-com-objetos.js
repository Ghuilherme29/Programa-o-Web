...
for (let i = 0; i < listaDeUsuarios.length; i++) {
  console.log(
    `${listaDeUsuarios[i].nome} tem ${listaDeUsuarios[i].idade} anos`,
  );
}
...
//Ex4. Procurar o usuário com 45 anos.
console.log("\nNa lista de usuário, encontre a pessoa que tem 45 anos: ");
const UsuarioEncontradoPoridade = listaDeUsuarios.find((u) => u.idade == 45);
console.log(
  `Nome: ${UsuarioEncontradoPoridade.nome}\nIdade: ${UsuarioEncontradoPoridade.idade}`,
);

// Ex.5 Somando as idades dos usuários
console.log("\nNa lista de usuário, somando todas as idades: ");
const somaIdade = listaDeUsuarios.reduce(
